    ...
    <div className="hero flex flex-col items-center justify-center" id='hero'>
      {/* Hero Image */}
        <div className="heroImg relative flex justify-center">
          ...
          {/* Name */}
          <div className="heroName absolute lg:bottom-[20vh] bottom-[30vh]">
          ...
          <div className="resumeBtn absolute bottom-0 flex items-center text-center mx-auto">
            <a
              ...
              className="mx-auto border flex items-center justify-evenly w-[40vw] md:w-[30vw] z-10 py-3 p-10 font-extrabold textStroke text-xl border-black rounded-full md:text-[2.2vw] lg:text-[2vw] hover:textNormal bg-white">
                <h3 className="my-auto">My Resume</h3><FaCloudDownloadAlt className="max-md:hidden stroke-current stroke-[20px] fill-white"/>
            </a>
          </div>
        </div>
