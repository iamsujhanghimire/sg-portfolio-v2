    ...
    <div className="hero flex flex-col items-center justify-center" id='hero'>
      {/* Hero Image */}
        <div className="heroImg relative flex justify-center">
          <img src="./img/sg-vector.png" className="max-h-[85vh] z-0 mx-auto" />
          {/* Name */}
          <div className="heroName absolute lg:bottom-[11vh] bottom-[20vh]">
          ...
          {/* Description */}
          <div className="heroDesc absolute bottom-[8vh] textStroke font-bold w-[90vw]">
